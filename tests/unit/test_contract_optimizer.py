...
from app.contract_optimizer import (
    ...
    find_optimum,
    get_next_eligible_contract_id,
)


class TestContractOptimiser:
    @patch("app.contract_optimizer.ContractOptimiser.find_optimum")
    ...
    def test_find_optimum_multiple_at_start(self, contracts_multiple_at_start_fixture):
        ...
        """
        with patch(
            "app.contract_optimizer.contracts", contracts_multiple_at_start_fixture
        ):
            total_price, path = find_optimum(0, 0)
    ...
    @patch("app.contract_optimizer.solution_cache", {})
    def test_find_optimum_5k_contracts(self, sorted_contracts_5k_fixture):
        """
    ...
    def test_get_next_eligible_contract_id_example_start_0(
        ...
        """
        with patch("app.contract_optimizer.contracts", sorted_contracts_fixture):
            contract_id = get_next_eligible_contract_id(0, 0)
    ...
    def test_get_next_eligible_contract_id_example_start_5(
        ...
        """
        with patch("app.contract_optimizer.contracts", sorted_contracts_fixture):
            contract_id = get_next_eligible_contract_id(0, 5)
    ...
    def test_get_next_eligible_contract_id_multiple_start_3(
        ...
        with patch(
            ...
            contract_id = get_next_eligible_contract_id(0, 3)
